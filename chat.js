...
IMPORTANT FORMATTING RULE: When listing multiple items (menu items, drinks, events, specials, etc.), put EACH item on its own new line. Never bunch multiple items together in a single paragraph. Use a newline character between each item.
